...
const app = createApp({
  setup() {
    ...
    return {
      ...
      showCreateFacility: S.showCreateFacility,
      facilityForm: S.facilityForm,
      showQuoteModal: S.showQuoteModal,
      ...
      quoteReq: S.quoteReq,
      quoteForm: S.quoteForm,
      showKanban: S.showKanban,
      activeCurrency: S.activeCurrency,
      showHealthDash: S.showHealthDash,
      healthStats: S.healthStats,
      buyerIntel: S.buyerIntel,
      showBuyerIntel: S.showBuyerIntel,
      showRecurringModal: S.showRecurringModal,
      recurringForm: S.recurringForm,
      recurringOrders: S.recurringOrders,
      discountCode: S.discountCode,
      discountApplied: S.discountApplied,
      showDraftBanner: S.showDraftBanner,
      showOrderNotes: S.showOrderNotes,
      orderNotesReq: S.orderNotesReq,
      orderNotesText: S.orderNotesText,
      referralData: S.referralData,
      warrantyItems: S.warrantyItems,
      myFacility: S.myFacility,
      facilityMembers: S.facilityMembers,
      inviteEmail: S.inviteEmail,
      inviteRole: S.inviteRole,
      productBenchmark: S.productBenchmark,
      productRequests: S.productRequests,
      newProductRequest: S.newProductRequest,
      newsletterEmail: S.newsletterEmail,
      recentlyViewed: S.recentlyViewed,
      showSearchSuggestions: S.showSearchSuggestions,
      searchSuggestions: searchSuggestions,
      dutyCategory: S.dutyCategory,
      dutyValue: S.dutyValue,
      dutyResult: S.dutyResult,
      verifiedSellers: S.verifiedSellers,
      arrivalCountdown: A.arrivalCountdown,
      quoteExpiryDisplay: A.quoteExpiryDisplay,
      detectDuplicateRequest: A.detectDuplicateRequest,
    };
  }
});
